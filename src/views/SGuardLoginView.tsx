    ...
    try {
      const response = await fetch('https://sguardai.khcho0421.workers.dev/auth/signup', {
        ...
        body: JSON.stringify({
          ...
          team: (signupForm.isPartnerManager && signupForm.company !== '신한DS') ? '영업총괄팀' : signupForm.team,
          part: (signupForm.isPartnerManager && signupForm.company !== '신한DS') ? '전사총괄' : signupForm.part,
